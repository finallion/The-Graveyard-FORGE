...
public class GhoulingModel extends AnimatedGeoModel<GhoulingEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(GhoulingEntity object) {
        return new ResourceLocation(TheGraveyard.MOD_ID, "geo/ghouling.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(GhoulingEntity object) {
        return texture;
    }

    @Override
    public ResourceLocation getAnimationFileLocation(GhoulingEntity animatable) {
