...
public class TheGraveyard {
    ...
    public void setupClient(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemModelsProperties.register(TGItems.VIAL_OF_BLOOD.get(), new ResourceLocation("charged"), (stack, world, entity, seed) -> {
                if (entity != null && stack.sameItem(TGItems.VIAL_OF_BLOOD.get())) {
    ...
    public static final ItemGroup GROUP = new ItemGroup("graveyard_group") {
        @Override
