...
public class OssuaryBlockEntityRenderer extends GeoBlockRenderer<OssuaryBlockEntity> {
    ...
    public OssuaryBlockEntityRenderer(BlockEntityRendererProvider.Context rendererDispatcherIn) {
        super(rendererDispatcherIn, new OssuaryModel());
    }

    @Override
    public RenderType getRenderType(OssuaryBlockEntity animatable, float partialTicks, PoseStack stack,
