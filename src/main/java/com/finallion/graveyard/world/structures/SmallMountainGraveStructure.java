...
public class SmallMountainGraveStructure extends StructureFeature<JigsawConfiguration> {
    private static final int SIZE = 4;

    public SmallMountainGraveStructure(Codec<JigsawConfiguration> codec) {
        super(codec, (context) -> {
            if (!SmallMountainGraveStructure.isFeatureChunk(context)) {
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(() -> SmallMountainGraveGenerator.STARTING_POOL, 10);
