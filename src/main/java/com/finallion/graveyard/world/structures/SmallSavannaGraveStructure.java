...
public class SmallSavannaGraveStructure extends StructureFeature<JigsawConfiguration> {
    private static final int SIZE = 4;

    public SmallSavannaGraveStructure(Codec<JigsawConfiguration> codec) {
        super(codec, (context) -> {
            if (!SmallSavannaGraveStructure.isFeatureChunk(context)) {
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(() -> SmallSavannaGraveGenerator.STARTING_POOL, 10);
