...
public class SmallSpruceTree05 extends BaseSpruceTree {
    ...
    public boolean place(ISeedReader world, ChunkGenerator generator, Random random, BlockPos blockPos, TGTreeFeatureConfig config) {
        ...
        randomSpreadOne(world, mutable.offset(0, 0, 0), false, 2);
        ...
        randomSpreadThree(world, mutable.offset(0, -4, 0), false, 2);
        randomSpreadTwo(world, mutable.offset(0, -5, 0), false, 2);
        generateOneStar(world, mutable.offset(0, -6, 0), false);
        randomSpreadThree(world, mutable.offset(0, -7, 0), false, 2);
        generateTwoStar(world, mutable.offset(0, -8, 0), false);
        randomSpreadThree(world, mutable.offset(0, -8, 0), false, 2);
        randomSpreadTwo(world, mutable.offset(0, -9, 0), false, 2);
        generateThreeStar(world, mutable.offset(0, -10, 0), false);
        randomSpreadFour(world, mutable.offset(0, -10, 0), false, 2);
        generateTwoStar(world, mutable.offset(0, -11, 0), false);
        randomSpreadThree(world, mutable.offset(0, -11, 0), false, 2);
        generateThreeStar(world, mutable.offset(0, -12, 0), false);
        randomSpreadFour(world, mutable.offset(0, -12, 0), false, 2);
