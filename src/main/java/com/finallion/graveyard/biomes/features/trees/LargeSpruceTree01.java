...
public class LargeSpruceTree01 extends BaseSpruceTree {
    ...
    public boolean place(ISeedReader world, ChunkGenerator generator, Random random, BlockPos blockPos, TGTreeFeatureConfig config) {
        ...
        randomSpreadTwo(world, mutable.offset(0, -3, 0), false, 5);
        ...
        randomSpreadThree(world, mutable.offset(0, -6, 0), true, 4);
        ...
        randomSpreadTwo(world, mutable.offset(0, -8, 0), false, 2);
        generateTwoStar(world, mutable.offset(0, -9, 0), false);
        generateTwoStar(world, mutable.offset(0, -10, 0), false);
        randomSpreadThree(world, mutable.offset(0, -10, 0), false, 4);
        generateBranchesOne(world, mutable.offset(0, -10, 0), 1, config);
        generateThreeStar(world, mutable.offset(0, -11, 0), true);
        generateThreeStar(world, mutable.offset(0, -12, 0), false);
        randomSpreadFour(world, mutable.offset(0, -12, 0), false, 4);
        generateFourStar(world, mutable.offset(0, -13, 0), false);
        ...
        generateTwoStar(world, mutable.offset(0, -16, 0), true);
        return false;
    }
}
