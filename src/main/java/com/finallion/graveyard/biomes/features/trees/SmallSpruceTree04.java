...
public class SmallSpruceTree04 extends BaseSpruceTree {
    ...
    public boolean place(ISeedReader world, ChunkGenerator generator, Random random, BlockPos blockPos, TGTreeFeatureConfig config) {
        ...
        generateTwoStar(world, mutable.offset(0, -3, 0), true);
        randomSpreadTwo(world, mutable.offset(0, -4, 0), false, 2);
        randomSpreadOne(world, mutable.offset(0, -5, 0), false, 2);

        generateTwoStar(world, mutable.offset(0, -6, 0), false);
        randomSpreadTwo(world, mutable.offset(0, -7, 0), false, 2);
        randomSpreadOne(world, mutable.offset(0, -8, 0), false, 2);

        generateThreeStar(world, mutable.offset(0, -9, 0), true);
        ...
        randomSpreadThree(world, mutable.offset(0, -13, 0), false, 2);
        randomSpreadTwo(world, mutable.offset(0, -14, 0), false, 2);

        generateFourStar(world, mutable.offset(0, -15, 0), true);
        randomSpreadFour(world, mutable.offset(0, -16, 0), false, 2);
        randomSpreadThree(world, mutable.offset(0, -17, 0), false, 2);

        generateFourStar(world, mutable.offset(0, -18, 0), false);
        randomSpreadFour(world, mutable.offset(0, -19, 0), false, 2);
        randomSpreadThree(world, mutable.offset(0, -20, 0), false, 2);
