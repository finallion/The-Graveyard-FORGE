...
public class TGItems {
    ...
    public static final RegistryObject<Item> INCARNATED_EVIL_MUSIC_DISC = ITEMS.register("incarnated_evil_music_disc", () -> new RecordItem(0, TGSounds.LICH_THEME_01, new Item.Properties().tab(TheGraveyard.GROUP).stacksTo(1), 5400));
