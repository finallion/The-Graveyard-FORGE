...
public class TGCommands {
    ...
    public static int executeSpawn(CommandSourceStack source) {
        source.sendSuccess(new TextComponent("Spawned a graveyard horde."), false);
    ...
    private static boolean spawnHordeEntity(Level p_64565_, BlockPos p_64566_, Random p_64567_, boolean p_64568_, boolean illagerSpawn) {
