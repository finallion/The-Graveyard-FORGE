...
public class MathUtil {
    ...
    public static <T extends ParticleOptions> void createParticleDisk(Level world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, float radius, T type, Random random) {
    ...
    public static <T extends ParticleOptions> void createParticleCircle(Level world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, float radius, T type, Random random, float thickness) {
        int surfaceArea = Mth.ceil(Math.PI * radius * radius); // circle surface area
    ...
    public static <T extends ParticleOptions> void createParticleFlare(Level world, double x, double y, double z, int length, T type, T type2, Random random, boolean inverted) {
        double yCoord = y + 1.1D; // top of block
